Feature: check Custom Event Feature
  ...
  Scenario: Check UIControl Event after clicking on "Create Custom_Event" button on Main Page
    ...
    Then Check Element value ["event-element" "MaterialButton:btn_create_event" 0]
    ...
    Then Check Element value ["event-description" "Pressed on Create Custom Event" 0]
  ...
  after clicking on "Create Custom Event" button on Main Page
    ...
    Then Check Element value ["page-name" "CreateEventActivity" 3]
  ...
  Scenario: Check UIControl Event after clicking on "Save" btn on Custom Event page
    ...
    Then Check Element value ["device-orientation" "Portrait" 1]
    Then Check Element value ["event-element" "MaterialButton:btn_save" 1]
    Then Check Element value is not null ["x-vf-trace-transaction-id" 1]
    Then Check Element value is not null ["x-vf-trace-timestamp" 1]
    Then Check Element value is not null ["x-vf-trace-session-id" 1]
    Then Check Element value ["page-name" "CreateEventActivity" 1]
    Then Check Element value ["subpage-name" "NA" 1]
    Then Check Element value ["x-vf-trace-tid" "NA" 1]
    Then Check Element value ["x-vf-user-id" "NA" 1]
    Then Check Element value ["x-vf-net-band" "NA" 1]
    Then Check Element value ["event-description" "Pressed on Save" 1]
  ...
  Scenario: Check UICustom Value after clicking on save button on Custom Event Page
    ...
    Then Check Element value ["device-orientation" "Portrait" 2]
    Then Check Element value ["event-element" "Custom Event Element" 2]
    Then Check Element value is not null ["x-vf-trace-transaction-id" 2]
    Then Check Element value is not null ["x-vf-trace-timestamp" 2]
    Then Check Element value is not null ["x-vf-trace-session-id" 2]
    Then Check Element value ["page-name" "CreateEventActivity" 2]
    Then Check Element value ["subpage-name" "NA" 2]
    Then Check Element value ["x-vf-trace-tid" "NA" 2]
    Then Check Element value ["x-vf-net-band" "NA" 2]
    Then Check Element value ["event-description" "Custom Event Description" 2]
    Then Check Element value is not null ["x-vf-user-id" 2]
