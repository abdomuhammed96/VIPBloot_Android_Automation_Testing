...
#    check event ["Application" "App launch time" "device-orientation" "Portrait"]
  ...
  Scenario: Check App Launched Event
    ...
    Then Validate Android Element ["page-name" "MainActivity"] for event ["Application" "App launched"]
    Then Validate Android Element ["device-orientation" "Portrait"] for event ["Application" "App launched"]
    Then Validate Android Element ["subpage-name" "NA"] for event ["Application" "App launched"]
