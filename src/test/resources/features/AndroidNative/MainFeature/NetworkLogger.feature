Feature: check Network Events when network is on
  ...
  Scenario: Check UIControl Event when clicking on OKHTTP3_GET_REQUEST button
    ...
    Then Validate Android Element ["event-description" "SMAPI_Presence"] for event ["UIControl" "MaterialButton:okhttp3GetRequest"]
  ...
  Scenario: Check UIControl Event when clicking on OKHTTP3_POST_REQUEST button
    ...
    Then Validate Android Element ["event-description" "SMAPI_Presence"] for event ["UIControl" "MaterialButton:okhttp3PostRequest"]
  ...
  Scenario: Check UIControl Event when clicking on OKHTTP2_GET_REQUEST button
    ...
    Then Validate Android Element ["event-description" "SMAPI_Presence"] for event ["UIControl" "MaterialButton:okhttp2GetRequest"]
  ...
  Scenario: Check UIControl Event when clicking on OKHTTP2_POST_REQUEST button
    ...
    Then Validate Android Element ["event-description" "SMAPI_Presence"] for event ["UIControl" "MaterialButton:okhttp2PostRequest"]
...
##############################################################
  ...
  Scenario: Check UIControl Event when clicking on URL_CONNECTION_GET_REQUEST button
    ...
    Then Validate Android Element ["event-description" "SMAPI_Presence"] for event ["UIControl" "MaterialButton:urlconnectiongetrequest"]
  ...
  Scenario: Check UIControl Event when clicking on URL_CONNECTION_POST_REQUEST button
    ...
    Then Validate Android Element ["event-description" "SMAPI_Presence"] for event ["UIControl" "MaterialButton:urlconnectionpostrequest"]
  ...
  Scenario: Check UIControl Event when clicking on VOLLEY_GET_REQUEST button
    ...
    Then Validate Android Element ["event-description" "SMAPI_Presence"] for event ["UIControl" "MaterialButton:volleyrequest"]
  ...
  Scenario: Check UIControl Event when clicking on VOLLEY_POST_REQUEST button
    ...
    Then Validate Android Element ["event-description" "SMAPI_Presence"] for event ["UIControl" "MaterialButton:volleypostrequest"]
  ...
  Scenario: Check UIControl Event when clicking on Custom Network Event button
    ...
    Then Validate Android Element ["event-description" "SMAPI_Presence"] for event ["UIControl" "MaterialButton:customrequest"]
