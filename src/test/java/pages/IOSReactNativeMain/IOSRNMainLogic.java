...
public class IOSRNMainLogic extends IOSRNMainAbstract {

    public IOSRNMainLogic() {
        super();
    }

    @Override
    public void clickOnIOSButton(String args) {
        MobileElement e = (MobileElement) driver.findElement(MobileBy.AccessibilityId(args));
//        MobileElement e = (MobileElement) driver.findElement(By.id(""));
        e.click();
    }
...
//    }
    ...
    @Override
    public boolean validateNumOfEventsCaptured(int arg0) {
        return checkEventsCaptured(arg0);
    }

    @Override
    public void setIOSRNUserID(String arg0) {
        MobileElement e = (MobileElement) driver.findElement(MobileBy.className("UITextField"));
        e.sendKeys(arg0);
    }
